...
public class first_task {
    ...
    public static void main(String[] args) {
        ...
        boolean useUpper = yesNoToBoolean(scr.next());
        System.out.println();

        System.out.print("Include lowercase letters? (Yes/No): ");
        boolean useLower = yesNoToBoolean(scr.next());
        System.out.println();

        System.out.print("Include numbers? (Yes/No): ");
        boolean useNumbers = yesNoToBoolean(scr.next());
        System.out.println();

        System.out.print("Include special characters? (Yes/No): ");
        boolean useSpecial = yesNoToBoolean(scr.next());
        System.out.println();
